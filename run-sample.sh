...
./_build/default/ocaml-core/src/tool/decompiler.exe -i $CWD/sample/add -func-path "$CWD/sample/add.funcs" -dump-path "$CWD/sample/" -dump-cfa -dump-spfa -dump-l1 -dump-basic-block -dump-l2
