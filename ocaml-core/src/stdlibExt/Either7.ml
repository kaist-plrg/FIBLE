...
let fold first second third fourth fifth sixth seventh = function
  | First x -> first x
  | Second x -> second x
  | Third x -> third x
  | Fourth x -> fourth x
...
let iter first second third fourth fifth sixth seventh :
    (_, _, _, _, _, _, _) t -> unit =
  fold first second third fourth fifth sixth seventh

let equal first second third fourth fifth sixth seventh a b =
  match (a, b) with
...
let compare first second third fourth fifth sixth seventh a b =
  match (a, b) with
  | First x, First y -> first x y
  | Second x, Second y -> second x y
  | Third x, Third y -> third x y
