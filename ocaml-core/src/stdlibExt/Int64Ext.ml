...
let cut_width_bit (v : t) (width : int32) : int64 =
  if width > 63l then v
    ...
    Int64.logand v (Int64.lognot (Int64.shift_left (-1L) (Int32.to_int width)))
...
let sext_bit (v : t) (in_width : int32) (out_width : int32) : int64 =
  let x = Int64.shift_left v (64 - Int32.to_int in_width) in
  let x = Int64.shift_right x (64 - Int32.to_int in_width) in
...
let zext_bit (v : t) (in_width : int32) (out_width : int32) : int64 =
  let x = Int64.shift_left v (64 - Int32.to_int in_width) in
  let x = Int64.shift_right_logical x (64 - Int32.to_int in_width) in
  cut_width_bit x out_width
